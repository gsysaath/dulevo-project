class CreateRolesTypes < ActiveRecord::Migration[6.1]
  def change
    create_table :roles_types, id: false, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", comment: "Tipo di ruolo / Types roles" do |t|
